...
export const EXERCISE_DB = [
  ...
  // —— 扩充：器械与变式 ——
  { n: '坐姿推胸机',    a: ['器械推胸', '坐姿推胸'], p: ['chest'], s: ['triceps'] },
  { n: '史密斯卧推',    a: ['史密斯架卧推'], p: ['chest'], s: ['triceps', 'shoulder'] },
  { n: '上斜器械推胸',  a: [], p: ['chest'], s: ['shoulder', 'triceps'] },
  { n: '龙门架飞鸟',    a: ['绳索飞鸟'], p: ['chest'], s: [] },
  { n: '史密斯深蹲',    a: [], p: ['quad', 'glute'], s: ['hamstring', 'core'], ecc: 1 },
  { n: '箱式深蹲',      a: ['箱子深蹲'], p: ['quad', 'glute'], s: ['hamstring'], ecc: 1 },
  { n: '泽奇深蹲',      a: [], p: ['quad', 'core'], s: ['glute'], ecc: 1 },
  { n: '相扑硬拉',      a: [], p: ['glute', 'hamstring'], s: ['back', 'quad'], ecc: 1 },
  { n: '直腿硬拉',      a: [], p: ['hamstring'], s: ['back', 'glute'], ecc: 1 },
  { n: '六角杠硬拉',    a: ['陷阱杠硬拉'], p: ['quad', 'back'], s: ['glute', 'hamstring'], ecc: 1 },
  { n: '单腿硬拉',      a: [], p: ['hamstring', 'glute'], s: ['core'], ecc: 1 },
  { n: '山羊挺身',      a: ['罗马椅挺身', '背部伸展'], p: ['back', 'hamstring'], s: ['glute'], ecc: 1 },
  { n: '早安式',        a: ['早安深蹲'], p: ['hamstring', 'back'], s: ['glute'], ecc: 1 },
  { n: '坐姿髋外展',    a: ['腿外展机', '髋外展'], p: ['glute'], s: [] },
  { n: '坐姿髋内收',    a: ['腿内收机', '髋内收'], p: ['quad'], s: ['glute'] },
  { n: 'T杠划船',       a: ['T形划船'], p: ['back'], s: ['biceps'] },
  { n: '辅助引体机',    a: ['辅助引体'], p: ['back', 'biceps'], s: ['forearm'] },
  { n: 'TRX划船',       a: [], p: ['back'], s: ['biceps', 'core'], bw: 1 },
  { n: 'TRX俯卧撑',     a: [], p: ['chest', 'core'], s: ['triceps'], bw: 1 },
  { n: '高位下压',      a: [], p: ['back'], s: ['triceps'] },
  { n: '器械推举',      a: ['坐姿推肩机'], p: ['shoulder'], s: ['triceps'] },
  { n: '颈后推举',      a: [], p: ['shoulder'], s: ['triceps'] },
  { n: '借力推举',      a: ['挺举推'], p: ['shoulder', 'full'], s: ['quad', 'triceps'] },
  { n: '反向蝴蝶机',    a: ['器械反向飞鸟'], p: ['shoulder'], s: ['back'] },
  { n: '集中弯举',      a: [], p: ['biceps'], s: [] },
  { n: '佐特曼弯举',    a: [], p: ['biceps', 'forearm'], s: [] },
  { n: '反握弯举',      a: [], p: ['forearm', 'biceps'], s: [] },
  { n: '哑铃臂屈伸',    a: [], p: ['triceps'], s: [] },
  // —— 核心与功能 ——
  { n: '侧平板支撑',    a: ['侧桥'], p: ['core'], s: ['shoulder'], bw: 1 },
  { n: '死虫式',        a: ['死虫'], p: ['core'], s: [], bw: 1 },
  { n: '鸟狗式',        a: ['鸟狗'], p: ['core'], s: ['glute'], bw: 1 },
  { n: '空中蹬车',      a: ['空中自行车'], p: ['core'], s: [], bw: 1 },
  { n: '反向卷腹',      a: [], p: ['core'], s: [], bw: 1 },
  { n: '仰卧抬腿',      a: ['仰卧举腿'], p: ['core'], s: [], bw: 1 },
  { n: 'V字支撑',       a: ['V字两头起'], p: ['core'], s: [], bw: 1 },
  { n: '农夫行走',      a: ['农夫走'], p: ['forearm', 'core'], s: ['back', 'full'] },
  { n: '壶铃摇摆',      a: ['壶铃摆动'], p: ['hamstring', 'glute'], s: ['core', 'shoulder'], ecc: 1 },
  { n: '跳箱',          a: ['跳箱子上'], p: ['quad', 'glute'], s: ['calf'], bw: 1 },
  { n: '高翻',          a: ['翻铃'], p: ['full'], s: ['back', 'quad', 'shoulder'] },
  { n: '抓举',          a: [], p: ['full'], s: ['shoulder', 'quad', 'back'] },
  // —— 有氧补充 ——
  { n: '爬楼梯机',      a: ['登山机', '楼梯机'], p: ['full'], s: ['quad', 'glute'], bw: 1, cardio: 1 },
  { n: '开合跳',        a: [], p: ['full'], s: [], bw: 1, cardio: 1 },
  { n: '高抬腿',        a: [], p: ['full'], s: ['quad'], bw: 1, cardio: 1 },
  { n: '登山跑',        a: ['登山者'], p: ['core', 'full'], s: ['shoulder'], bw: 1, cardio: 1 },
  { n: '战绳',          a: ['甩绳'], p: ['full', 'shoulder'], s: ['core'], bw: 1, cardio: 1 },
  { n: '滑雪机',        a: [], p: ['full'], s: ['back'], bw: 1, cardio: 1 },
  { n: '瑜伽',          a: ['瑜伽课'], p: ['full'], s: ['core'], bw: 1, cardio: 1 },
  { n: '普拉提',        a: [], p: ['core', 'full'], s: [], bw: 1 },
  { n: '徒步',          a: ['爬山'], p: ['full'], s: ['quad'], bw: 1, cardio: 1 },
  { n: '篮球',          a: [], p: ['full'], s: [], bw: 1, cardio: 1 },
  { n: '羽毛球',        a: [], p: ['full'], s: [], bw: 1, cardio: 1 },
  { n: '足球',          a: [], p: ['full'], s: ['quad'], bw: 1, cardio: 1 },
  { n: '网球',          a: [], p: ['full'], s: [], bw: 1, cardio: 1 },
];
